import { hasInjectionContext, getCurrentInstance, version, unref, inject, ref, readonly, toRef, isRef, onMounted, nextTick, watch, mergeProps, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isShallow, isReactive, toRaw, withCtx, defineComponent, computed, h, Suspense, Transition } from 'vue';
import { u as useRuntimeConfig$1, q as withQuery, r as hasProtocol, t as parseURL, v as isScriptProtocol, m as joinURL, n as createError$1, $ as $fetch, x as sanitizeStatusCode, y as createHooks, a as defu, z as parse, A as getRequestHeader, B as destr, C as isEqual, D as setCookie, g as getCookie, E as deleteCookie } from '../nitro/vercel.mjs';
...
const _routes = [
  {
    name: "first-second-short",
    path: "/:first()/:second()/:short()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_short_-eb42be7c.mjs').then((m) => m.default || m)
  },
  {
    name: "first-short",
    path: "/:first()/:short()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_short_-91e11d69.mjs').then((m) => m.default || m)
  },
  {
    name: "short",
    path: "/:short()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_short_-24fe998b.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-short",
    path: "/blog/:short()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_short_-12e81a3a.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/dashboard-34063295.mjs').then((m) => m.default || m)
  },
  {
    name: "gh-short",
    path: "/gh/:short()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_short_-3ae39801.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0b4a4f74.mjs').then((m) => m.default || m)
  }
];
...
const LazyPCalendar = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/calendar.esm-88ccf8e2.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-c0ad282f.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-2108b821.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-d84b55d1.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { BaseStyle as B, ConnectedOverlayScrollHandler as C, DomHandler as D, ObjectUtils as O, Ripple as R, UniqueComponentId as U, ZIndexUtils as Z, _export_sfc as _, useSupabaseClient as a, useSupabaseUser as b, createError as c, useRoute as d, entry$1 as default, useNuxtApp as e, useStyle as f, injectHead as i, navigateTo as n, primebus as p, resolveUnrefHeadInput as r, useRouter as u };
